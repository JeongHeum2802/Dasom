  ...
  return (
    <div className="h-full flex-1 flex flex-col bg-pink-100 text-gray-800 relative">
      ...
      <div className="flex flex-col items-center justify-center p-12">
        ...
        />
        <h1 className="text-5xl font-bold mb-4 text-pink-500">{userData.main.name}</h1>
        <p className="text-2xl text-center max-w-2xl mt-6 text-gray-700">{userData.main.message}</p>
      </div>
      <div className="bg-pink-200 p-6 flex justify-around">
