    ...
    <>
      ...
      <div className="flex flex-col w-full items-center pt-10 bg-pink-50 min-h-screen">
        <div className="relative mb-8 mt-16">
          <img src={userImg} className="rounded-full w-80 h-80 object-cover border-8 border-pink-200 shadow-lg" />
        ...
        <div className="w-full max-w-lg space-y-6">
          ...
          {/* Email Input */}
          <div className="bg-white rounded-full shadow-lg p-2 flex items-center">
            <span className="px-6 text-gray-500 font-semibold">이메일</span>
            <input
              type="email"
              value={email}
